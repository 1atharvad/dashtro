    ...
    def set_document_data(self, path, data):
        ...
        if parts[0] == '_schema' and len(parts) == 2:
            ...
            self.db['cms_workspace_data'].replace_one(
                {'workspace_name': workspace_name, 'collection_id': collection_id, 'document_id': document_id},
                {'workspace_name': workspace_name, 'collection_id': collection_id, 'document_id': document_id, 'data': data},
                upsert=True
            )
